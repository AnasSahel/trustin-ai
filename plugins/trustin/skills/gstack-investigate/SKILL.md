...
1. **Collect symptoms:** Read the error messages, stack traces, and reproduction steps. If the user hasn't provided enough context, gather all missing context in a single AskUserQuestion — list every piece of information you need at once.
