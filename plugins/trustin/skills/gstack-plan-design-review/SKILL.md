...
**STOP.** If issues were found in this section, collect ALL of them and present in a single AskUserQuestion — list each with your recommendation and WHY. If no issues, say so and move on. Do NOT proceed until user responds.
...
**STOP.** If issues were found in this section, collect ALL of them and present in a single AskUserQuestion — list each with your recommendation and WHY.
