...
**STOP.** If issues were found in this section, collect ALL of them and present in a single AskUserQuestion — list each issue, your recommendation, and the options. Do NOT make multiple sequential stops for the same section. Only proceed after the user responds.
